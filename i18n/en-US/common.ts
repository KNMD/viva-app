const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Wonder account',
    langGeniusAccountTip: 'Your Wonder account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Wonder to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Wonder allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Wonder\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Wonder {{version}} is now available.',
    latestAvailable: 'Wonder {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
