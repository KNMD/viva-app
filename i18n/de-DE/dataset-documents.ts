const translation = {
  list: {
    title: 'Dokumente',
    desc: 'Alle Dateien des Wissens werden hier angezeigt, und das gesamte Wissen kann mit Wonder-Zitaten verknüpft oder über das Chat-Plugin indiziert werden.',
    ...
    empty: {
      ...
      sync: {
        tip: 'Wonder wird periodisch Dateien von Ihrem Notion herunterladen und die Verarbeitung abschließen.',
      },
    },
    delete: {
