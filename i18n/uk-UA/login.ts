const translation = {
  ...
  welcome: 'Ласкаво просимо до Wonder, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском Wonder Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда Wonder',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте Wonder',
