const translation = {
  ...
  welcome: 'Welcome to Wonder, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Wonder Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on Wonder',
  invalid: 'The link has expired',
  explore: 'Explore Wonder',
