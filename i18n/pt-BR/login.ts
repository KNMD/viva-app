const translation = {
  ...
  welcome: 'Bem-vindo ao Wonder, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do Wonder, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no Wonder',
  invalid: 'O link expirou',
  explore: 'Explorar o Wonder',
