const translation = {
  ...
  welcome: 'Bienvenue sur Wonder, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Wonder Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Wonder',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Wonder',
