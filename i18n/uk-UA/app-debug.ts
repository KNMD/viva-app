const translation = {
  ...
  automatic: {
    ...
    description: 'Опишіть свій сценарій, Wonder збере для вас застосунок.',
  ...
  formattingChangedText: 'Змінення форматування призведе до скидання області налагодження. Ви впевнені?', // MoWondering the formatting will reset the debug area, are you sure?
  ...
  datasetConfig: {
    ...
    retrieveChangeTip: 'Зміна  режиму індексування та режиму отримання може вплинути на застосунки, пов’язані з цими знаннями.', // MoWondering...
  },
